...
import PreviewDocCard from "@/components/blocks/DocCardOnline";
...
const FindDoctor = () => {
  return (
    <section className="min-h-[calc(100dvh_-_8rem)] rounded-sm">
      <div className="p-10">
        ...
        <Tabs defaultValue="online" className="mt-4">
          ...
          <TabsContent value="online">
            <div className="grid grid-cols-[repeat(auto-fill,minmax(250px,1fr))] gap-6">
              <PreviewDocCard className="shadow-sm border-[1px]" />
              <PreviewDocCard className="shadow-sm border-[1px]" />
              <PreviewDocCard className="shadow-sm border-[1px]" />
              <PreviewDocCard className="shadow-sm border-[1px]" />
              <PreviewDocCard className="shadow-sm border-[1px]" />
