	...
	return (
		<div className='space-y-8 mt-8'>
			...
			{appointments.map((appointment, index) => (
				<div
					className='flex flex-col bg-muted/20 sm:flex-row items-stretch sm:items-center border rounded-lg shadow-sm hover:shadow-md transition-all duration-200 ease-in-out'
					key={appointment?.id}
				>
