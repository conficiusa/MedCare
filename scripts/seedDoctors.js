...
const sampleImageUrl =
	"https://xgyzgqc7wzq7cyz6.public.blob.vercel-storage.com/profile_pictures/doctormale-qBY6PE4kCPiM5k8f0AYTQqLIkQlFNy.jpgBgM_bA6nLSsHLW_AIlufi";
const sampleImageTwoUrl =
	"https://xgyzgqc7wzq7cyz6.public.blob.vercel-storage.com/profile_pictures/mock%20use%20%282%29-jjRkkC0ZpM6tH4iovuOzq647vUvVHG.jpgNxF7XH4wIMC3DfricS-GA";
const sampleImageUrlThumbnail =
	"https://xgyzgqc7wzq7cyz6.public.blob.vercel-storage.com/profile_pictures/thumbnails/doctormale-vlfrUmT1ySvxn8q9tT1QuVVxeP9KwT.jpglsoDCIwe_AwtnKbFXvZAL";
const sampleImageTwoUrlThumbnail =
	"https://xgyzgqc7wzq7cyz6.public.blob.vercel-storage.com/profile_pictures/thumbnails/mock%20use%20%282%29-vVPKWiSqiTnIWErAkXCcA7MpNoNwXf.jpgT-VPvYWTUUHJegQ3OmuiQ";
...
const usersData = names.map((name, index) => {
	...
	return {
		...
		thumbnail:
			index % 2 === 0 ? sampleImageUrlThumbnail : sampleImageTwoUrlThumbnail,
