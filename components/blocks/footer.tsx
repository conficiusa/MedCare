// const Footer = () => {
//   return (
//     <footer className="bg-black text-white flex xl:justify-between xl:items-center p-4 text-sm max-sm:flex-col">
//       <ul className="flex justify-center xl:items-center gap-6 max-xl:flex-col max-xl:order-1">
//         <li>About</li>
//         <li>Contact us</li>
//         <li>Our Services</li>
//         <li>List Your Practices </li>
//         <li>Terms of Service</li>
//         <li>Privacy Policy</li>
//       </ul>

//       <ul className="flex xl:justify-center gap-3 max-xl:order-1 md:flex-1 max-xl:flex-1">
//         <li>
//           <svg
...
const Footer = () => {
  return (
    <footer className="min-h-[50dvh] w-full container bg-black text-white">
      <div className="grid lg:grid-cols-[400px_1fr] md:p-10 border-b border-muted-foreground max-md:py-5 gap-y-5">
        <div className="hidden md:block">
          <h1 className="text-xl font-medium tracking-wide mb-5">
            Medcare Hub
          </h1>
        ...
        <div className="grid md:grid-cols-3 grid-cols-2 gap-y-5 gap-x-3">
          <div>
            ...
            <ul className="text-sm space-y-3">
              <li>
                <Link href="/rent">Our services</Link>
              </li>
              <li>
                <Link href="/rent">List your Practice</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="text-sm space-y-3">
              ...
              <li>
                <Link href="/pricing">Why Medcare Hub</Link>
              </li>
            </ul>
          </div>
          <div>
      ...
      <div className="py-2 md:px-10 md:py-5">
        <div className="text-sm text-muted-foreground font-semibold space-y-4">
          ...
          <p>&copy; {new Date().getFullYear()} Medcare Hub. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
